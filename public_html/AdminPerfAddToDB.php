...
<html>
<head>
<title>FestivalWare Administration Performance Registration Completed</title>
		...
		<form name="form1" method="post" action="">
		  <table width="100%" border="1">
			<tr> 
			  ...
			  <td width="12%">&nbsp;</td>
			  <td width="44%" align="center">Click below to return to the Festival Administration page</td>
			</tr>
			<tr> 
			  <td align="center"> 
				  <input name="btnRegAnother" type="button" id="btnRegAnother" onClick="window.location='AdminPerfEnterNew.php'" value="Register Another Performance">
				</td>
			  <td> </td>
			  <td align="center">
				  <input name="btnFestivalAdmin" type="button" id="btnFestivalAdmin" onClick="window.location='Administration.php'" value="Back to Studio Administration">
			  </td>
			</tr>
		  </table>
		</form> 
