...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" background="img/lightbrown.jpg"> 
...
<?php				
	...
	if(mysql_num_rows($result) > 0) {
		print "<br><h3 align=\"center\"><font color=\"#FF00FF\">$studentFullName is already entered. </font></h3><br></td></tr>";
	}
	else {
	...
	print "<font size=\"+1\">You have successfully ADDED $studentFullName.<br>";
...
?>
	<tr><td>
            <table width="100%" border="1">
              <tr> 
                <td width="44%"> <div align="center"> <font size="+1">Click below 
                    to go back to the <br>Studio Administration Page </font> </div></td>
                <td width="12%">&nbsp;</td>
                <td width="44%"> <div align="center"> <font size="+1">Click below 
                    to log out </font> </div></td>
              </tr>
              <tr> 
                <td> <div align="center"> 
              		<input name="btnGoBack" type="button"  onClick="window.location='StudioAdmin.php'" id="StudioNav" value="Back to Studio Administration">
                  </div></td>
                <td> </td>
                <td> <div align="center"> 
