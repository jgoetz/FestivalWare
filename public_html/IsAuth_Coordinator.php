...
*/
	...
	$notAuthenticated = ! (isset($_SESSION['AuthenticatedUser']) && ($_SESSION['AuthorizationType'] == "Coordinator") );
	...
	if($notAuthenticated)
	{
		...
		$LoginMessage = "You have not been authorized to access " . $_SERVER['REQUEST_URI'] 
							. "<br>Please log in...";
	...
	{
		session_register("LoginMessage");
		$LoginMessage = "You have not been authorized to access " . 
