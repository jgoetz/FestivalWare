...
<html>
<head>
<title>FestivalWare Administration Edit Performance Levels</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" background="img/lightbrown.jpg">
	...
	<td width="25%">&nbsp;</td><td width="25%">&nbsp;</td><td width="25%">&nbsp;</td><td width="25%">&nbsp;</td>
	 ...
	 <tr><td colspan="4" align="center"> <h2>Edit Performance Levels </h2></td></tr>
	<tr>
	  <td colspan="4" align="center">Directions: Select your performance levels</td>
	</tr>
  <tr> 
...
<?php
	...
	$sql = "SELECT * FROM PerformanceLevels";
	...
	while($row = mysql_fetch_array($allLevelsResult))
	{
		if( ($noLevels == false) and (array_key_exists($row['PerfLevelID'],$festLevelsRevArray) ) )
			print "<tr><td align=\"right\"><input name=\"chkBox[]\" type=\"checkbox\" value=\"$row[PerfLevelID]\" checked></td><td align=\"left\">$row[Description]</td></tr>";
		else
			print "<tr><td align=\"right\"><input name=\"chkBox[]\" type=\"checkbox\" value=\"$row[PerfLevelID]\"></td><td align=\"left\">$row[Description]</td></tr>";
