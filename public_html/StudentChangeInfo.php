...
<html>
<head>
<title>FestivalWare Change Student Information</title>
...
<form  method="post" name="frmStudentRegistration" onSubmit="return checkSpecial(this)" action="StudentUpdateDB.php">
...
<tr><td width="50%"><input type="hidden" name="hdnStudentsStudioID" value="<?php print $row['StudioID']; ?>" title="Students Studio ID"></td>
	<td width="50%"><input type="hidden" name="hdnMyStudioID" value="<?php print $_SESSION['StudioID']; ?>" title="My Studio ID"></td>
</tr>
...
<tr><td align="right" height="30" height="30"><font size="+1" color="#ff0000">Student's Zip code</font>: </td>
