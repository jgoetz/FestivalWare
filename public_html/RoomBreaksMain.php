...
<form method="post" name ="frmAddRoom" onSubmit="return checkReqEntries(this)" action="AdminAddRoomToDB.php">
...
<?php
	...
	{
		print "<tr><td align=\"center\">$row[RoomDescription]</td><td><input type=\"button\" name=\"btnChange\" value=\"Change\" onClick=\"location='AdminRoomChange.php?roomid=$row[RoomID]'\"><input type=\"button\" name=\"btnDelete\" value=\"Delete\" onClick=\"location='AdminRoomDelete.php?roomid=$row[RoomID]'\"></td></tr>";
	}
...
?>
	...
	<tr><td align="center" colspan="2">&nbsp;</td></td></tr>
	<tr><td align="center" colspan="2">Enter new room description: <input type="text" name="txtRoomDescr" maxlength="25" size="25"></td></tr>
	<tr>
